...
output "eks_managed_nodegroups" {
  ...
  value       = module.eks_cluster.managed_node_groups
}

output "eks_managed_node_group_ids" {
  description = "EKS managed node group ids"
  value       = module.eks_cluster.managed_node_groups_id
}

output "eks_managed_nodegroup_arns" {
  description = "EKS managed node group arns"
  value       = module.eks_cluster.managed_node_group_arn
}

output "eks_managed_nodegroup_iam_role_names" {
  description = "EKS managed node group role name"
  value       = module.eks_cluster.managed_node_group_iam_role_names
}

output "eks_managed_nodegroup_status" {
  description = "EKS managed node group status"
  value       = module.eks_cluster.managed_node_groups_status
}
