...
output "default_network_acl_id" {
  ...
  value       = try(aws_vpc.main.default_network_acl_id, "")
}
...
output "vpc_instance_tenancy" {
  ...
  value       = try(aws_vpc.main.instance_tenancy, "")
}
...
output "vpc_main_route_table_id" {
  ...
  value       = try(aws_vpc.main.main_route_table_id, "")
}

output "vpc_owner_id" {
  description = "The ID of the AWS account that owns the VPC"
  value       = try(aws_vpc.main.owner_id, "")
}
...
output "dhcp_options_id" {
  ...
  value       = try(aws_vpc_dhcp_options.vpc_dhcp[0].id, "")
}
...
#   value       = { for az, m in local.public_subnet_output_map : az => m.subnet_id }
# }

# output "private_subnet_ids" {
#   description = "Map of AZ names to private subnet IDs"
#   value       = { for az, m in local.private_subnet_output_map : az => m.subnet_id }
# }

# output "database_subnet_ids" {
#   description = "Map of AZ names to database subnet IDs"
#   value       = { for az, m in local.database_subnet_output_map : az => m.subnet_id }
# }

# output "public_subnet_cidr_block" {
#   description = "Map of AZ names to public subnet CIDR"
#   value       = { for az, m in local.public_subnet_output_map : az => m.subnet_cidr_block }
# }

# output "private_subnet_cidr_block" {
#   description = "Map of AZ names to private subnet CIDR"
#   value       = { for az, m in local.private_subnet_output_map : az => m.subnet_cidr_block }
# }

# output "database_subnet_cidr_block" {
#   description = "Map of AZ names to database subnet CIDR"
#   value       = { for az, m in local.database_subnet_output_map : az => m.subnet_cidr_block }
# }

# output "public_route_table_ids" {
#   description = "Map of AZ names to public route table ID"
#   value       = { for az, m in local.public_subnet_output_map : az => m.route_table_id }
# }

# output "private_route_table_ids" {
#   description = "Map of AZ names to private route table ID"
#   value       = { for az, m in local.private_subnet_output_map : az => m.route_table_id }
# }

# output "database_route_table_ids" {
#   description = "Map of AZ names to database route table ID"
#   value       = { for az, m in local.database_subnet_output_map : az => m.route_table_id }
# }

# output "ngw_ids" {
#   description = "Map of AZ names to NAT gateway IDs"
#   value       = { for az, m in local.public_subnet_output_map : az => m.ngw_id }
# }