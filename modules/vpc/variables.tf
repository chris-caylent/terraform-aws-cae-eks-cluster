...
variable "is_prod" {
  type        = bool
  description = <<-EOT
    A boolean flag that enables creation or deletion of prod resources. 
    An example use case is when you need to create prod resources but preserve something
    like an Elastic IP address for your firewalls.
    EOT
  default     = false
}
...
# variable "cidr_block" {
#   type        = string
#   description = "The base IPv4 CIDR block for the VPC and subnets."
...
#   type        = bool
#   description = "Flag to enable/disable public subnets upon VPC creation (defaults to true)"
#   default     = true
# }

# variable "private_enabled" {
#   type        = bool
#   description = "Flag to enable/disable private subnets upon VPC creation (defaults to true)"
#   default     = true
# }

# variable "database_enabled" {
#   type        = bool
#   description = "Flag to enable/disable database subnets upon VPC creation (defaults to false)"
#   default     = false
# }

# variable "elasticache_enabled" {
#   type        = bool
#   description = "Flag to enable/disable elasticache subnets upon VPC creation (defaults to false)"
#   default     = false
# }
...
#   type        = bool
#   description = "Flag to enable/disable creation of IGW in the VPC"
#   default     = false
# }

# variable "public_cidr_block" {
#   type        = string
#   description = "The public subnet range inside the VPC"
#   default     = "10.30.50.0/20"
# }

# variable "private_cidr_block" {
#   type        = string
#   description = "The private subnet range inside the VPC"
#   default     = "10.30.100.0/20"
# }

# variable "database_cidr_block" {
#   description = "(Optional) The database subnet range inside the VPC"
#   type        = string
#   default     = ""
# }
...
# variable "database_network_acl_id" {
#   type        = string
#   description = "Network ACL ID that is added to the database subnets. If empty, a new ACL will be created"
#   default     = ""
# }
